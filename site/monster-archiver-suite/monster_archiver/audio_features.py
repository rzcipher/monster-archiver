...
def detect_lossy_upconvert(file_path):
    ...
    on success or None on failure. Only called for lossless files.
    """
    ...
    threshold = float(state.CONF.get("UPCONVERT_ENERGY_THRESHOLD", 0.9999))
