...
export default function LibraryTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-void-900 rounded-xl border border-void-700 p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-2.5">
          <input
            ...
            className="flex-1 bg-void-950 border border-void-700 rounded-lg py-2.5 px-4 text-white text-sm font-mono focus:outline-none focus:border-deezer-500 transition-colors"
          />
          <button
            onClick={() => saveDir(dirInput)}
            disabled={savingDir || loadingSettings || !dirInput.trim() || dirInput === libraryDir}
            className="px-4 py-2.5 bg-gradient-to-r from-deezer-600 to-flow-500 hover:from-deezer-500 hover:to-flow-400 shadow-md shadow-deezer-500/10 disabled:bg-slate-800 disabled:text-slate-600 text-white rounded-lg text-sm font-semibold transition-colors cursor-pointer border-0 shrink-0"
          >
          ...
          <button
            ...
            className="px-4 py-2.5 bg-void-950 hover:bg-slate-800 disabled:text-slate-600 text-slate-300 border border-void-700 rounded-lg text-sm font-medium transition-colors cursor-pointer shrink-0"
          >
            Use Default
          </button>
        </div>
      ...
      {/* HEALTH SCAN */}
      <div className="bg-void-900 rounded-xl border border-void-700 p-6">
        <div className="flex items-center justify-between border-b border-void-700/60 pb-3 mb-5 flex-wrap gap-3">
          <h3 className="text-white font-medium text-lg flex items-center gap-2">
            <ShieldCheck className="w-5 h-5 text-deezer-400" />
            Library Health Scan
          </h3>
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-deezer-600 to-flow-500 hover:from-deezer-500 hover:to-flow-400 shadow-md shadow-deezer-500/10 disabled:bg-slate-800 disabled:text-slate-600 text-white rounded-lg text-sm font-semibold transition-colors cursor-pointer border-0 flex items-center gap-2"
            >
        ...
        {scanResult && (
          <div>
            <div className="grid grid-cols-3 gap-4 mb-5">
              <div className="bg-void-950 rounded-lg p-3 border border-void-700/60 text-center">
            ...
            {scanResult.flagged === 0 ? (
              ...
              <div className="overflow-y-auto max-h-[320px] custom-scrollbar border border-void-700/60 rounded-lg">
                <table className="w-full text-xs">
                  <thead className="sticky top-0 bg-void-950 text-slate-500 uppercase tracking-wider">
                    <tr>
                  ...
                  <tbody>
                    {scanResult.issues.map((issue, idx) => (
                      <tr key={idx} className="border-t border-void-700/60">
      ...
      <div className="bg-void-900 rounded-xl border border-void-700 p-6">
        <div className="flex items-center justify-between border-b border-void-700/60 pb-3 mb-5 flex-wrap gap-3">
          <h3 className="text-white font-medium text-lg flex items-center gap-2">
            <Merge className="w-5 h-5 text-deezer-400" />
            Merge Split Albums
          </h3>
          <button
        ...
        {mergePreview && (
          <div className="bg-void-950 rounded-lg p-4 border border-void-700/60 flex items-center justify-between flex-wrap gap-3">
        ...
        {mergeResult && (
          <div className="bg-void-950 rounded-lg p-4 border border-void-700/60 mt-4">
