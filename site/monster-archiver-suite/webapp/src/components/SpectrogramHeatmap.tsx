...
export default function SpectrogramHeatmap({
  ...
  if (!image || !fileInfo || !bytes) {
    return (
      <div className="flex flex-col items-center justify-center h-64 bg-slate-900/40 rounded-2xl border border-void-700">
  ...
  return (
    <div className="bg-void-900 rounded-xl border border-void-700 p-6 relative overflow-hidden">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-5 border-b border-void-700/60 pb-4">
        <div className="flex items-center gap-3">
          <div className="p-2.5 bg-deezer-950/40 rounded-xl border border-deezer-800/20 text-deezer-400">
      ...
      <div className="relative w-full mb-6 rounded-lg overflow-hidden bg-black/40 border border-void-700/60" style={{ aspectRatio: `${W} / ${H}` }}>
      ...
      <div className="bg-slate-900/50 rounded-xl border border-void-700 p-4 mb-6">
        <div className="flex gap-2.5 items-start">
          <Sparkles className="w-5 h-5 text-deezer-400 shrink-0 mt-0.5" />
          <div className="text-sm">
            ...
            <span className="text-slate-300">
              {!isLossless
                ...
                : suspect
                  ? `\u26A0\uFE0F Flagged upconvert. Although the container is a lossless format, the audio signal experiences a sudden drop and an absolute cutoff at ${(maxActiveFreq / 1000).toFixed(1)} kHz. Real lossless files carry active signal, tape hiss, or noise-shaping dither above 18.5 kHz.`
      ...
      <div className="bg-void-950 rounded-xl border border-void-700 p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
          {[
            ...
            <div key={label} className="bg-void-900 rounded-lg p-3 border border-void-700/60">
